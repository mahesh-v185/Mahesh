  ...
  const semestersData: Record<number, any> = {
    ...
    3: {
      ...
      original: [
        ...
        { slNo: 7, code: '73308', name: 'LAB - DBMS', max: 50, min: 20, see: 29, ia: 8, scored: 37, credits: 1, grade: 8.2, points: 8.2, letter: 'A', status: 'Pass' },
        { slNo: 8, code: '73309', name: 'LAB - C and .NET Framework', max: 50, min: 20, see: 30, ia: 8, scored: 38, credits: 1, grade: 8.4, points: 8.4, letter: 'A', status: 'Pass' },
        { slNo: 9, code: '73310', name: 'LAB - Computer Networks', max: 50, min: 20, see: 24, ia: 6, scored: 32, credits: 1, grade: 8.2, points: 8.2, letter: 'A', status: 'Pass' },
      ],
      summary: {
